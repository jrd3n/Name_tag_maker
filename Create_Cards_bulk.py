...
if __name__ == "__main__":
    ...
    # Read guest names from the Excel file.
    excel_file = "Guests-wedding breakfast-03-06-2025.xlsx"
    
    # Adjust the column names according to your Excel file.
    guests_df = pd.read_excel(excel_file)

    ERROR_LIST = []
    
    # Loop over each guest row.
    for idx, row in guests_df.iterrows():
        ...
        try:
            ...
            ERROR_LIST.append(f"{first_name}, {last_name}")
